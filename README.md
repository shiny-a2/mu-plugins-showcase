...
- [Catalog image batching](docs/catalog-image-batching.md) — rejecting failed cutouts before export, preserving reusable templates, and distinguishing queue tests from visual acceptance.
